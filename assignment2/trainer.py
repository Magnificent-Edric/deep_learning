...
class Trainer:
    ...
    def get_params(self):
        return {'batch_size': self.batch_size, 'learning_rate':self.learning_rate, 'optim': self.optim, 'decay':self.learning_rate_decay, 'model':self.model}
    ...
    def fit(self):
        ...
        for epoch in range(self.num_epochs):
            ...
            if np.not_equal(self.learning_rate_decay, 1.0):
                ...
                self.learning_rate = self.learning_rate / (1 + self.learning_rate_decay * self.num_epochs)
